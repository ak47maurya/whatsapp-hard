		...
		switch (statusCode) {
			case resDisconnectReason.serviceOpen:
				...
				case resDisconnectReason.serviceQr:
					...
					addJson = {
						...
						state: "QRCODE",
						status: "qrRead",
						message: "Waiting for QR code to be read."
					};
					//
					break;
			...
			case resDisconnectReason.clientOutdated:
				...
				addJson = {
					...
					message: "Client outdated, update required"
				};
				//
				break;
			...
			case resDisconnectReason.CATExpired:
				...
				addJson = {
					...
					state: "AUTH_FAILED",
					status: "tokenExpired",
					message: "Expired encrypted authentication token"
				};
				//
				break;
			case resDisconnectReason.CATInvalid:
				...
				addJson = {
					...
					state: "AUTH_FAILED",
					status: "invalidToken",
					message: "Invalid encrypted authentication token"
				};
				//
				break;
			...
			case resDisconnectReason.experimental:
				...
				addJson = {
					...
					state: "ERROR",
					status: "experimental",
					message: "Experimental Resource Problem"
				};
				//
				break;
